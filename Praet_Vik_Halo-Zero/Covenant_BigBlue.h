...
class Covenant_BigBlue: public BaseEnemy
{
public:
	Covenant_BigBlue(const Rectf& levelBoundaries, const Point2f& position, float scale);
	~Covenant_BigBlue();
...
private:
	...
	const float		m_SecPerShootingFrame;
