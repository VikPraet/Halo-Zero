...
class PlasmaGrenade: public BaseGrenade
{
public:
	PlasmaGrenade(const Point2f& starPos, bool isLookingLeft, float scale);
	~PlasmaGrenade();
...
private:
	...
	void CheckAttach(std::vector<BaseEnemy*>& enemies);
	void CheckAttach(Avatar*& avatar);
};
