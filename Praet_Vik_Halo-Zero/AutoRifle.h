...
class AutoRifle: public BaseWeapon
{
public:
	AutoRifle(const Rectf& levelBoundaries, bool isHeldByPlayer, float scale);
	~AutoRifle();
...
private:
	...
	std::vector<BulletImpactYellow*>	m_pBulletImpacts;
	std::vector<BulletCasing*>			m_pBulletCasings;
