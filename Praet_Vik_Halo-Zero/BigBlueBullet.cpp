...
Texture* BigBlueBullet::m_pBulletTexture{ nullptr };
int BigBlueBullet::instanceCounter{ };

BigBlueBullet::BigBlueBullet(const Point2f& centerPos, float angle, bool isGoingLeft, float scale) :
	m_BulletDamage{ 35.f },
	m_Shape{ 0.f, 0.f, 35.f, 12.f },
	m_CenterPosition{ },
	m_StartPos{ centerPos },
	m_Angle{ angle },
	m_Velocity{	410.f, 0.f },
						  ...
						  Point2f{m_Shape.left, m_Shape.bottom + m_Shape.height} }
{
	if (m_pBulletTexture == nullptr) {
		m_pBulletTexture = new Texture("Textures/Bullet_BigBlue.png");
	}
	++instanceCounter;
	m_Velocity.x *= m_Scale;
}

BigBlueBullet::~BigBlueBullet()
{
	--instanceCounter;
...
void BigBlueBullet::Update(float elapsedSec)
{
...
Point2f BigBlueBullet::GetCenterPos() const
{
...
Point2f BigBlueBullet::GetLeftMiddlePos() const
{
...
Point2f BigBlueBullet::GetRightMiddlePos() const
{
...
float BigBlueBullet::GetBulletDamage() const
{
	return m_BulletDamage;
}

void BigBlueBullet::CleanUp()
{
	BigBlueBullet::~BigBlueBullet();
}