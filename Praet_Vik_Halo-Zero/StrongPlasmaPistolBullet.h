...
class StrongPlasmaPistolBullet: public BaseBullet
{
public:
	StrongPlasmaPistolBullet(const Point2f& centerPos, float angle, bool isGoingLeft, float scale);
	~StrongPlasmaPistolBullet();
