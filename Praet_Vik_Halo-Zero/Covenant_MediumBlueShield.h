...
class Covenant_MediumBlueShield: public BaseEnemy
{
public:
	Covenant_MediumBlueShield(const Rectf& levelBoundaries, const Point2f& position, float scale);
	~Covenant_MediumBlueShield();
